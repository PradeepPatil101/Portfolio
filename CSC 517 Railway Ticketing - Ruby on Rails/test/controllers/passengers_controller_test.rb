...
class PassengersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create passenger" do
    assert_difference('Passenger.count') do
      post passengers_url, params: { passenger: { address: @passenger.address, credit_card_info: @passenger.credit_card_info, email: @passenger.email, name: @passenger.name, password: @passenger.password, phone_number: @passenger.phone_number } }
    end
  ...
  test "should update passenger" do
    patch passenger_url(@passenger), params: { passenger: { address: @passenger.address, credit_card_info: @passenger.credit_card_info, email: @passenger.email, name: @passenger.name, password: @passenger.password, phone_number: @passenger.phone_number } }
